...
The Tier-1 ground-truth values (six dipeptide × regulator pairs) are reproduced from Sung J-Y *et al.*, "Keratin degradation reflects a starvation survival strategy in *Fervidobacterium islandicum* AW-1," *iScience* 2026 (Cell Press); PII S2589-0042(26)01130-2; URL https://www.cell.com/iscience/fulltext/S2589-0042(26)01130-2 (DOI 10.1016/j.isci.2026.115755; article ID confirmed 2026-05-08). The six values appear in the chemotaxis-linked persister-like adaptation analysis of the published version and are reproduced verbatim in `Claude_web/Revision.txt`. The Tier-1 values appear in **Table S5** and **Figure S10** of the published *iScience* version. See `06_Report/Mr_Prof/primary_paper_relationship.md` for the full procedure-mapping and citation plan. The supporting primary paper is **peer-reviewed and published**, satisfying Nature Protocols' supporting-research-paper requirement.
